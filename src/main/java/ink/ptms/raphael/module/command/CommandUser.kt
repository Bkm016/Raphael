...
object CommandUser : CommandHandle() {
    ...
    @TInject
    val raphaelUserAddGroup = CommandBuilder.create("RaphaelUserAddGroup", null)
    ...
    @TInject
    val raphaelUserDelGroup = CommandBuilder.create("RaphaelUserDelGroup", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserAddVariable = CommandBuilder.create("RaphaelUserAddVariable", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserDelVariable = CommandBuilder.create("RaphaelUserDelVariable", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserAddPermission = CommandBuilder.create("RaphaelUserAddPermission", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserDelPermission = CommandBuilder.create("RaphaelUserDelPermission", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserClearPermission = CommandBuilder.create("RaphaelUserClearPermission", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserClearVariables = CommandBuilder.create("RaphaelUserClearVariables", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserClearGroups = CommandBuilder.create("RaphaelUserClearGroups", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserCheckPermission = CommandBuilder.create("RaphaelUserCheckPermission", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserListPermission = CommandBuilder.create("RaphaelUserListPermission", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserListVariables = CommandBuilder.create("RaphaelUserListVariables", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserListGroups = CommandBuilder.create("RaphaelUserListGroups", null)
            .permission("raphael.command")
    ...
    @TInject
    val raphaelUserInfo = CommandBuilder.create("RaphaelUserInfo", null)
            .permission("raphael.command")
